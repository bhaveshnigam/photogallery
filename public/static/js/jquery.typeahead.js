...
(function (factory) {
    ...
    Typeahead.prototype = {
            ...
            this.node.off(_namespace).on(events.join(' '), function (e) {
                ...
                switch (e.type) {
                    ...
                    case "input":
                        ...
                        scope.query = scope.rawQuery.replace(/^\s+/, '').trim();
                ...
                for (var k = 0; k < this.source[group].length; k++) {
                    ...
                    for (var i = 0; i < displayKeys.length; i++) {
                        ...
                        if (~[undefined, true].indexOf(groupFilter)) {
                            comparedDisplay = displayKeys[i].split('.').reduce(this.helper.getObjectAttribute, item);
                            ...
                            _liHtml = $("<li/>", {
                                ...
                                "html": $("<a/>", {
                                    ...
                                    "click": ({"item": item}, function (e) {
                                        ...
                                        scope.query = scope.rawQuery = item.matchedKey.split('.').reduce(scope.helper.getObjectAttribute, item).toString();
        ...
        buildHintLayout: function (result) {
            ...
            if (this.node[0].scrollWidth > this.node.innerWidth() && this.hint.container) {
                this.hint.container.val("");
                return;
            }
        ...
        helper: {
          ...
          getObjectAttribute: function(obj,i) {
              if (obj) {
                return obj[i]
              } else {
                return undefined
...
// {debug}
    ...
    // Commenting out unnecessary log print.
